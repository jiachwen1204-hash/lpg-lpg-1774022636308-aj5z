        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="absolute inset-4 rounded-card-lg bg-white border border-surface-border flex flex-col items-center justify-center p-8">
                  ...
                  <div className="grid grid-cols-3 gap-4 w-full mt-4">
                    {CONTENT.stats.map((stat, i) => (
                      <div key={stat.label} className="text-center p-3 rounded-xl bg-surface hover:bg-surface-overlay transition-colors">
                        <div className="font-heading font-black text-xl md:text-2xl text-brand-500">
                          {stat.value}
                        </div>
          ...
          <AnimateIn direction="right" delay={100}>
            ...
            <h2 className="font-heading font-black text-display-lg text-content-primary mb-6 leading-tight">
              Finance faster, smarter{/* space */}
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-brand-500 via-violet-500 to-brand-500 bg-[length:200%_auto] animate-shimmer">
              ...
              {CONTENT.values.map((v, i) => (
                <li key={v} className="flex items-start gap-4 text-content-primary group">
                  <div className="relative">
                    ...
                    <CheckCircle className="w-6 h-6 text-brand-500 shrink-0 mt-0.5 relative" />
                  </div>
            ...
            <div className="relative inline-flex">
              ...
              <a
                ...
                className="relative inline-flex px-8 py-4 font-body font-bold text-lg bg-brand-500 text-white rounded-pill hover:bg-brand-600 hover:shadow-glow transition-all ease-expo-out"
              >
                {CONTENT.cta.label}
